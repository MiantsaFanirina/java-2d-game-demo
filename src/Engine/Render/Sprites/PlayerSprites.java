...
public class PlayerSprites {
    ...
    public PlayerSprites(int characterRow) {
        ...
        BufferedImage sheet = ImageLoader.loadImage(path + "Character Model.png");
        if (sheet == null) {
            throw new RuntimeException("Failed to load player spritesheet from " + path + "Character Model.png");
        }
